navbarMenu(title = "Wellbeing of children and young people",
           icon = icon_no_warning_fn("child"),
           ...
           tabPanel(title = "Positive desinations of school leavers",
                    ...
                    fluidRow(
                      column(6,
                             actionButton(
                               "positive_destinations_modal_info",
                      ...
                      column(6,
                             actionButton(
                               "positive_destinations_modal_comment",
                    ...
                    br(),
                    uiOutput("school_leavers_category_ui"),
           ...
           tabPanel(title = "Protection from harm",
                    ...
                    fluidRow(
                      column(6,
                             actionButton(
                               "protection_from_harm_modal_info",
                               tags$b("Background information and source"),
                               icon = icon_no_warning_fn("info-circle")
                             )
                      ),
                      column(6,
                             actionButton(
                               "protection_from_harm_modal_comment",
                               tags$b("Summary of indicator during covid and pre-covid period"),
                               icon = icon_no_warning_fn("info-circle")
                             )
                      )
