                                         ...
                                         h2("Alcohol-related hospital admissions",
                                            iButtonUI("alcohol_admissions",
                                                      content = paste("This indicator provides data on hospital admissions where alcohol-related conditions",
                                                                      ...
                                                                      "<br><br>Source:",
                                                                      "<a href=https://publichealthscotland.scot/publications/alcohol-related-hospital-statistics/alcohol-related-hospital-statistics-scotland-financial-year-2021-to-2022/ target = _blank> Alcohol related hospital statistics, Public Health Scotland (PHS) (external site)</a>.",
                                         ...
                                         h2("Alcohol-specific deaths",
                                            iButtonUI("alcohol_deaths",
                                                      content = paste("This indicator provides data on hospital admissions where alcohol-related deaths.",
                                                                      "<br><br>Source:",
                                                                      "<a href=https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/deaths/alcohol-deaths/ target = _blank> Alcohol-specific deaths, 2021, National Records of Scotland (NRS) (external site)</a>.",
                        ...
                        h2("All-cause mortality (ages 15-44)",
                           iButtonUI("all_cause_mortality",
                                     content = paste("This indicator provides data on the number and rate of all causes of death.",
                                                           "<br><br>Source:",
                                                           "<a href= https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/general-background-information/ target = _blank> Vital Events - General Background information, National Records of Scotland (NRS) ( external site)</a>.",
                                                           "and",
                               ...
                               tabPanel(title = "Drug-related hospital admissions",
                                        ...
                                        h2("Drug-related hospital admissions", iButtonUI("drug_admissions",
                                                                                         content = paste("This indicator provides data on hospital admissions specifically relating to",
                                                                                                         ...
                                                                                                         "<br><br>Source:",
                                                                                                         "<a href=https://www.publichealthscotland.scot/publications/show-all-releases?id=32315/ target = _blank>  Drug-related hospital statistics, Public Health Scotland (PHS) (external site)</a>.",
                               ...
                               tabPanel(title = "Drug-related deaths",
                                        ...
                                        h2("Drug-related deaths", iButtonUI("drug_deaths",
                                                                            content =  paste("This indicator provides data on drug-related deaths.",
                                                                                             "<br><br>Source:",
                                                                                             "<a href=https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/deaths/drug-related-deaths-in-scotland/ target = _blank>  Drug Related Deaths in Scotland, National Records of Scotland, NRS (external site)</a>.",
               ...
               tabPanel(title = "Healthy birthweight",
                        ...
                        h2("Healthy birthweight", iButtonUI("healthy_birthweight",
                                                            ...
                                                            " for gestational age with a birthweight between the 10th and 90th percentiles.",
                                                                             "<br><br>Source:",
                                                                             "<a href=https://www.publichealthscotland.scot/publications/births-in-scotland/births-in-scottish-hospitals-year-ending-31-march-2021/ target = _blank> Source: Births in Scotland, Public Health Scotland (PHS) (external site)</a>.",
                                                                             "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                                                             "the year range 2019/20.",
                                                                             "More up to data is available at source.",
                                                                             "<br><br>These data are available at Scotland level,",
                                                                              " NHS Health Board and Council Area levels.",
                                                                             "<br><br> More detailed information can be found in the accompanying metadata file."))),
                                ...
                                tabPanel(title = "Life expectancy",
                                         ...
                                         h2("Life expectancy",
                                            iButtonUI("life_expectancy",
                                                      content =  paste("This indicator provides data on life expectancy.",
                                                                       "<br><br>Source:",
                                                                       "<a href=https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/life-expectancy/life-expectancy-in-scotland/2019-2021/ target = _blank> Life Expectancy in Scotland, National Records of Scotland (NRS) (external site)</a>.",
                                                                       "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                         ...
                                         h2("Healthy life expectancy",
                                            iButtonUI("healthy_life_expectancy",
                                                      content =  paste("This indicator provides data on healthy life expectancy.",
                                                                       "<br><br>Source:",
                                                                       "<a href=https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/life-expectancy/healthy-life-expectancy-in-scotland/ target = _blank>  Healthy Life Expectancy in Scotland, National Records of Scotland (NRS) (external site)</a>.",
                                                                       "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                                                       "the year range 2019/21.",
                                                                       #"More up to data is available at source.",
                                                                       "<br><br>These data are available at Scotland level",
               ...
               tabPanel(title = "Premature mortality",
                        ...
                        h2("Premature mortality", iButtonUI("premature_mortality",
                                                            content =paste("This indicator  provides data on premature mortality",
                                                                           ...
                                                                           "<br><br>Source:",
                                                                           "<a href=https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/deaths/ target = _blank> Vital Events - Deaths, National Records of Scotland (NRS) (external site)</a>.",
                                                                           "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                                                           "2021.",
                                                                           #"More up to data is available at source.",
                                                                           "<br><br>These data are available at Scotland,",
                                        ...
                                        h2("Screening uptake for breast cancer",
                                           ...
                                           iButtonUI("screening_breast",
                                                     content = paste("This indicator provides data on the number of women invited to attend for breast cancer screening.",
                                                                     "<br><br>Source:",
                                                                     "<a href=https://www.healthscotland.scot/health-topics/screening/breast-screening/ target = _blank> Breast screening, Public Health Scotland (PHS) (external site)</a>.",
                                                                     "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                        ...
                                        h2("Screening uptake for bowel cancer",
                                           iButtonUI("screening_bowel",
                                                     ...
                                                     "and women invited to attend for bowel cancer screening.",
                                                                     "<br><br>Source:",
                                                                     "<a href=https://publichealthscotland.scot/publications/scottish-bowel-screening-programme-statistics/scottish-bowel-screening-programme-statistics-for-the-period-of-invitations-from-may-2020-to-april-2022/ target = _blank> Scottish bowel screening programme statistics, Public Health Scotland (PHS)(external site)</a>.",
                                                                     "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                        ...
                                        h2("COVID-19 vaccinations uptake",
                                           iButtonUI("vaccinations_covid",
                                                     content = paste("This indicator shows the percentage uptake of COVID-19",
                                                                     ...
                                                                     "<br><br>Source:",
                                                                     "<a href=https://publichealthscotland.scot/our-areas-of-work/immunisations/seasonal-immunisations/ target = _blank>  Seasonal  Immunisations, Public Health Scotland (PHS)(external site)</a>.",
                                                                     "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                                                     "is January, 2023.",
                                                                     #"More up to data is available at source.",
                                                                     "<br><br>These data are available at Scotland level",
                               ...
                               tabPanel(title = "Influenza vaccinations",
                                        ...
                                        h2("Influenza vaccinations uptake",
                                           iButtonUI("vaccinations_FLU",
                                                     content = paste("This indicator shows the percentage uptake of influenza",
                                                                       "vaccinations during seasonal vaccination programmes.",
                                                                       "<br><br>Source:",
                                                                       "<a href=https://publichealthscotland.scot/our-areas-of-work/immunisations/seasonal-immunisations/ target = _blank>  Seasonal  Immunisations, Public Health Scotland (PHS) (external site)</a>.",
                                                                       "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is",
