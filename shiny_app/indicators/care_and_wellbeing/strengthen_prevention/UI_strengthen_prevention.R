                        ...
                        tabBox(title = "", id = "drugs_tabBox", type = "pills", width = NULL,
                               ...
                               tabPanel(title = "Drug-related hospital admissions",
                                        ...
                                        h2("Drug-related hospital admissions", iButtonUI("drug_admissions",
                                                                                         ...
                                                                                         "a diagnosis of drug misuse. These data are presented at a national level and broken",
                                                                                         "down by demographic characteristics/local geographies. More information can be found",
