                               ...
                               tabPanel(title = "Drug-related hospital admissions",
                                        ...
                                        h2("Drug-related hospital admissions", iButtonUI("drug_admissions",
                                                                                         content = paste("This indicator provides data on hospital admissions specifically relating to",
                                                                                                         ...
                                                                                                         "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is 2019/20.",
                                                                                                         "More up to date data is available at source.",
                                        ...
                                        h2("Screening uptake for breast cancer",
                                           ...
                                           iButtonUI("screening_breast",
                                                     content = paste("This indicator provides data on the percentage of women attending breast cancer screenings.",
                                                                     "<br><br>Source:",
                                                                     "<a href=https://publichealthscotland.scot/publications/scottish-breast-screening-programme-statistics/scottish-breast-screening-programme-statistics-annual-update-to-31-march-2022/ target = _blank> Breast screening, Public Health Scotland (external site)</a>.",
                                                                     "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is",
                                        ...
                                        h2("Screening uptake for bowel cancer",
                                           iButtonUI("screening_bowel",
                                                     content = paste("This indicator provides data on the percentage of men and women attending bowel cancer screenings.",
                                                                     "<br><br>Source:",
                                                                     "<a href=https://publichealthscotland.scot/publications/scottish-bowel-screening-programme-statistics/scottish-bowel-screening-programme-statistics-for-the-period-of-invitations-from-may-2020-to-april-2022/ target = _blank> Scottish bowel screening programme statistics, Public Health Scotland (external site)</a>.",
                                                                     "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is",
                                                                     "2020-2022 year range.",
                                                                     #"More up to date data is available at source.",
                                                                     "<br><br>These data are available at Scotland,",
                                        ...
                                        h2("COVID-19 vaccinations uptake",
                                           iButtonUI("vaccinations_covid",
                                                     content = paste("This indicator shows the percentage uptake of COVID-19",
                                                                     ...
                                                                     "<br><br>Source:",
                                                                     "<a href=https://publichealthscotland.scot/our-areas-of-work/immunisations/seasonal-immunisations/ target = _blank>  Seasonal  Immunisations, Public Health Scotland (external site)</a>.",
                                                                     "<br><br>The most current data available displayed in the Care and Wellbeing dashboard is ",
                                                                     "is January, 2023.",
                                                                     #"More up to date data is available at source.",
                                                                     "<br><br>These data are available at Scotland",
