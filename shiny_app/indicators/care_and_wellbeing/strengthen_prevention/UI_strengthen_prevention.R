                                         ...
                                         h2("Alcohol-related hospital admissions",
                                            iButtonUI("alcohol_admissions",
                                                      content = paste("This indicator provides data on hospital admissions where alcohol-related conditions",
                                                                      ...
                                                                      "<br><br>Source:",
                                                                      "<a href=https://publichealthscotland.scot/publications/alcohol-related-hospital-statistics/alcohol-related-hospital-statistics-scotland-financial-year-2021-to-2022/, target = _blank> Source: Alcohol related hospital statistics, PHS (external site)</a>.",
                                                                      ...
                                                                      "<br><br>These data are available at Scotland and NHS Health Board levelx.  ",
                                                                      "<br><br> More detailed information can be found in the accompanying metadata file."))),
