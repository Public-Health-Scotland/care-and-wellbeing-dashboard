               ...
               tabPanel(title = "Child social and physical development",
                        ...
                        h2("Child social and physical development",
                           iButtonUI("child_development_cw", content =  paste("This indicator provides data on Health Visitors\\'",
                                                                              ...
                                                                              "<br><br>Source:",
                                                                              "<a href=https://publichealthscotland.scot/publications/show-all-releases?id=20569/ target = _blank> Early child development, Public Health Scotland (PHS) (external site)</a>.",
               ...
               tabPanel(title = "Infant mortality",
                        ...
                        h2("Infant mortality",
                           iButtonUI("infant_mortality_cw", content = paste("This indicator provides data on all deaths in the first year  of life;",
                                                                            ...
                                                                            "<br><br>Source:",
                                                                            "<a href=https://scotland.shinyapps.io/phs-covid-wider-impact/ target = _blank>  COVID-19 wider impacts on the health care system, Public Health Scotland (PHS) (external site)</a>.",
                                                                            "<br><br>The most current data available displayed in the Care and Wellbeing dashboard",
                                                                            "is March, 2022.",
                                                                            "More up to data is available at source.",
                                                                            "<br><br>These data are available at Scotland",
